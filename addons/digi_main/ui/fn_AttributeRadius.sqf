...
private _fnc_onKeyUp = {
    ...
    if (_maxradius == 0) then {
		...
		_display setVariable ["digi_ui_radiusMax",_maxradius];
    };
	...
	if (_minradius == 0) then {
        ...
        if(_minradius > _maxradius) then {
            ...
            _display setVariable ["digi_ui_radiusMin",_minradius];
        };
    };
};
...
private _fnc_onCheckChange = {
    ...
    _display setVariable ["digi_ui_sealable",_cansealed];
};
...
private _fnc_onLBSelChange = {
    ...
    _display setVariable ["digi_ui_gastype",_gastype];
};
